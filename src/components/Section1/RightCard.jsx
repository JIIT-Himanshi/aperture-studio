...
const RightCard = (props) => {
  return (
    <div className='group relative h-full shrink-0 overflow-hidden rounded-4xl border border-(--border-soft) bg-(--surface) shadow-[0_20px_60px_rgba(0,0,0,0.28)] transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] md:hover:-translate-y-1 snap-center w-[80vw] sm:w-[78vw] md:w-[17rem]'>
      <img src={props.img} alt="Card Image" className='h-full w-full object-cover brightness-[0.72] saturate-[0.9] transition-[transform,filter] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:brightness-[0.9] md:group-hover:scale-[1.02] active:scale-95' />
